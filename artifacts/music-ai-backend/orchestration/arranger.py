...
STYLES = {
    ...
    "hasidic": {
        "name": "חסידי / Hasidic",
        "genre": "Hasidic",
        "description": "Traditional Hasidic/Klezmer with clarinet-lead melody, accordion, and freylekhs dance rhythms",
        "tags": ["jewish", "klezmer", "traditional", "dance"],
        "instruments": ["drums", "bass", "piano", "strings", "brass"],
        "density": 0.80,
        "harmonic_tendencies": ["minor", "phrygian", "dorian"],
        "rhythm_feel": "freylekhs",
    },
    "middle_eastern": {
        "name": "מזרחי / Middle Eastern",
        "genre": "Middle Eastern",
        "description": "Mizrahi/Arabic style with maqam scales, oud-like guitar, darbuka percussion, and ornamental melody",
        "tags": ["mizrahi", "arabic", "maqam", "oud"],
        "instruments": ["drums", "bass", "guitar", "strings", "pad"],
        "density": 0.72,
        "harmonic_tendencies": ["phrygian_dominant", "double_harmonic", "hijaz"],
        "rhythm_feel": "maqsum",
    },
    "hiphop": {
        "name": "Hip-Hop / Trap",
        "genre": "Hip-Hop",
        "description": "Modern hip-hop beat with heavy 808 bass, trap hi-hats, and pitched vocal chops",
        "tags": ["trap", "808", "urban", "beats"],
        "instruments": ["drums", "bass", "pad", "lead_synth"],
        "density": 0.88,
        "harmonic_tendencies": ["minor", "pentatonic"],
        "rhythm_feel": "trap",
    },
    "ballad": {
        "name": "Ballad",
        ...
        "instruments": ["piano", "strings", "pad", "bass"],
        "density": 0.45,
        "harmonic_tendencies": ["major", "minor", "extended"],
        "rhythm_feel": "rubato",
    },
    "cinematic": {
        "name": "Cinematic",
        ...
        "instruments": ["strings", "brass", "piano", "pad", "drums"],
        "density": 0.90,
        "harmonic_tendencies": ["major", "minor", "modal", "chromatic"],
        "rhythm_feel": "march",
    },
    "wedding": {
        "name": "Wedding Band",
        "genre": "Wedding",
        "description": "Festive wedding band sound with full horns, rhythm section, and crowd-pleasing arrangements",
        "tags": ["festive", "horns", "celebration", "live"],
        "instruments": ["drums", "bass", "piano", "brass", "strings", "guitar"],
        "density": 0.85,
        "harmonic_tendencies": ["major", "minor"],
        "rhythm_feel": "swing_ballroom",
    },
    "acoustic": {
        "name": "Acoustic / Folk",
        "genre": "Acoustic",
        ...
        "density": 0.40,
        "harmonic_tendencies": ["major", "pentatonic"],
        "rhythm_feel": "folk",
    },
}
